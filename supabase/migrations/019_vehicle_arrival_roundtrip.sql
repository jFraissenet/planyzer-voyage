alter table public.event_tool_vehicles
  add column event_tool_vehicle_arrival_location text,
  add column event_tool_vehicle_is_round_trip boolean not null default false,
  add column event_tool_vehicle_return_date timestamptz;
...
language sql security definer stable set search_path = '' as $$
  select
    ...
    v.event_tool_vehicle_is_round_trip,
